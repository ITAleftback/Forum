...
$(".layui-elem-field #essay-username").html(username)
...
layui.use('table', function(){
    ...
    //第一个实例
    $.post({
        url: "http://114.55.107.62:8080/essay/yourEssay",
        data:{
            username:username
        },
        dataType: "json",
        ...
        success: function (data){
            ...
            table.on('tool(test)', function(obj){ //注：tool 是工具条事件名，test 是 table 原始容器的属性 lay-filter="对应的值"
                ...
                if(layEvent === 'detail'){ //查看
                    ...
                    window.location.href="../forum/essay_View.html"
...
function delEssay(obj){
    $.post({
        ...
        success:function (data){
            alert(data.msg)
            window.location.href="../essay_Update.html"
        },
